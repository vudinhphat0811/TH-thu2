        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
                ...
                <ul class="list-unstyled mb-0">
                    <li class="mb-2">
                        <a href="/webbanhang/Product/shop" class="text-muted text-decoration-none hover-white small">
                            <i class="fas fa-shopping-bag mr-2 text-success"></i>Cửa sắm mua sắm
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="/webbanhang/Product/" class="text-muted text-decoration-none hover-white small">
                            <i class="fas fa-boxes mr-2"></i>Danh sách sản phẩm (Admin)
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="/webbanhang/Product/add" class="text-muted text-decoration-none hover-white small">
